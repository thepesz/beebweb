          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-10 md:gap-8 mb-14">
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                ...
                <li><a href="https://www.instagram.com/beebsi_app/" target="_blank" rel="noopener noreferrer" className="text-sm text-white/35 hover:text-cyan-400/80 transition-colors duration-200">@beebsi_app</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                <li>
                  <a href="https://www.instagram.com/beebsi_app/" target="_blank" rel="noopener noreferrer" className="text-sm text-white/35 hover:text-cyan-400/80 transition-colors duration-200 inline-flex items-center gap-1.5">
