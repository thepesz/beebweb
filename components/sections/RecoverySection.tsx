        ...
        <div className="hud-corners hud-corners-inner flex flex-col md:flex-row items-center gap-12 md:gap-16 py-4 px-4 md:px-8">
          ...
          <div className="reveal-left flex-1 text-center md:text-left">
            ...
            <p className="text-sm text-white/40 mt-4 max-w-lg leading-relaxed">
              {t.crossLinkPre[locale]}<a href="#strain" className="text-cyan-400/60 hover:text-cyan-400 transition-colors duration-200 underline underline-offset-2 decoration-cyan-400/20 hover:decoration-cyan-400/60">{t.crossLinkActivities[locale]}</a>{t.crossLinkPost[locale]}
            </p>
            <div className="mt-10 flex flex-wrap gap-3 justify-center md:justify-start">
              <span className="hud-tag">{t.tagSleep[locale]}</span>
              <span className="hud-tag">{t.tagRecovery[locale]}</span>
              <span className="hud-tag">{t.tagStrain[locale]}</span>
            </div>
          </div>
